...
uint8_t  MS_Data_Pack200[ 4 ] = { 0x00,0x01,0x02,0x03 }; 
...
int main( void )
{
	...
	while( 1 )
    {
	    if( USBFS_DevEnumStatus )
	    {
            ...
            MS_Scan_Handle( );
			USBFS_Endp_DataUp(DEF_UEP2,MS_Data_Pack200,sizeof(MS_Data_Pack200),DEF_UEP_CPY_LOAD); // the way to send some data
